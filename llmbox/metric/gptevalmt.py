...
class GPTEvalMT(Metric):
    ...
    def __call__(self, predictions, references):
        ...
        for pred, refer in tqdm(zip(predictions, references), desc="Judging", total=len(predictions)):
            parts = pred.split("__SEPARATOR__")
