...
class vllmModel(Model):
    ...
    def __init__(self, args: ModelArguments):
        ...
        self.tokenizer.model_max_length = min(self.model.llm_engine.model_config.max_model_len, getattr(args, 'max_length') or 1e10)
    ...
    def get_ppl(self, batched_inputs):
        ...
        batched_encodings = self.tokenizer(prompt, truncation=True, return_offsets_mapping=True, return_attention_mask=False)
    ...
    def set_generation_args(self, **kwargs):
        generation_kwargs = {}
        for key in ['temperature', 'top_p', 'top_k', 'max_tokens', 'best_of', 'frequency_penalty', 'presence_penalty', 'repetition_penalty', 'length_penalty', 'early_stopping', 'stop']:
