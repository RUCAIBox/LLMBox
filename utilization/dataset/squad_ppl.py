...
class SquadPPL(ValidationPerplexityDataset):
    ...
    def format_instance(self, instance):
        instance["options"] = [instance["answers"]["text"][0] if instance["answers"]["text"] else "Not in background."]
        return instance

    def no_construct_examples(self, instance=None) -> str:
