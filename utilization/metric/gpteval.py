...
class GPTEval(Metric):
    ...
    def __call__(self, predictions, references):
        ...
        if self.type == "single":
            ratings = self._get_single_ratings(predictions, references, model)
        elif self.type == "pairwise":
            ratings = self._get_pairwise_ratings(predictions, references, model)
        else:
    ...
    def _get_single_ratings(self, predictions, references, model):
        responses = []
